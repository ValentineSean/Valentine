<template>
    <div class="relative overflow-hidden bg-[#F2F5EA] border min-h-[100vh]">
        <div class="relative flex flex-col pt-6 pb-16 sm:pb-24">
                ...
                >
                    <div class="flex items-center justify-between flex-1">
                        ...
                        >
                            <a
                                href="/"
                                class="text-4xl font-black text-[#1E1E1E]"
                            >
                                SEAN.
                            </a>
                        ...
                        <div class="hidden md:flex">
                            <a
                                href="#footer"
                                class="inline-flex items-center px-4 py-2 text-sm font-bold text-gray-700 border-2 border-transparent border-gray-700 hover:text-white hover:bg-orange-700"
                            >
                                Contact Me
                            </a>
                        </div>
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            <a
                                href="#footer"
                                class="block w-full px-5 py-3 font-medium text-center text-white bg-gray-700 hover:bg-gray-100 hover:text-gray-700"
                            >
                                Contact Me
                            </a>
                        </div>
            ...
            <main class="flex-1 mt-8 sm:mt-32">
                <div class="mx-auto max-w-7xl">
                    <div
                        class="flex flex-col items-center px-4 sm:px-6 sm:text-center lg:mx-0 lg:col-span-6"
                    >
                        <img
                            :src="avatar"
                            alt=""
                            class="w-48 h-48 lg:h-none lg:w-none"
                        />
                        <span
                            class="mb-4 text-3xl font-bold text-black lg:text-5xl md:block"
                            >Valentine Sean</span
                        >
                        <p
                        ...
                        <a
                            href="#projects"
                            class="inline-flex items-center px-16 py-4 mt-12 text-sm font-bold text-white bg-black hover:text-white hover:bg-orange-700"
                        >
                            My Work
                        </a>
                        <!--
                        <div
                            class="flex flex-col items-start w-full py-2 mt-2 border sm:mx-auto lg:ml-0"
                        >
                            <p
                                class="mb-2 text-sm font-semibold tracking-wide text-gray-700 sm:mt-10"
                            >
                                Follow me
                            </p>
